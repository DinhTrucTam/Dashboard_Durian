...
export class SensorsComponent implements OnInit {
  ...
  ngOnInit() {
    this.sensorService.receiveTemperatureLightSensorData().subscribe(data => {
      ...
      this.lsn50v28Sensors[3].status.connection = 'Connected';
    ...
    this.sensorService.receiveTemperatureHumidityECData().subscribe(data => {
      ...
      this.lse018Sensors[4].status.connection = 'Connected';
    ...
    this.sensorService.receiveTemperatureHumidityData().subscribe(data => {
      ...
      if (stringData[2] == "FALSE"){
        this.lsn50v2S31BSensors[2].alarm_first = 'NORMAL'; // Alarm
      }
      else{
        this.lsn50v2S31BSensors[2].alarm_first = 'DANGER'; // Alarm
      }
      ...
      this.lsn50v2S31BSensors[4].status.connection = 'Connected';
