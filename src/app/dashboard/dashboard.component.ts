...
export class DashboardComponent implements OnInit {
  ...
  constructor(private auth: AuthService, private sensorService: SensorService, @Inject(DashboardDataService) private dashboardDataService:DashboardDataService) { }
